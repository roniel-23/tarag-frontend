...
<template>
  <div class="container mx-5 lg:mx-0 lg:max-w-screen-xl lg:mx-auto mt-10">
    <header>
      <nav>
        <h2 class="font-semibold text-xl mb-2">Pages Route</h2>
        <div class="grid gap-1 text-green-600">
